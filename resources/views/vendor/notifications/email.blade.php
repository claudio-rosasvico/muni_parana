                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{ asset('img/candado.png') }}" alt="candado"
                                                                            title="image"
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-font-size"
                                                                ...
                                                                <span>Si olvidaste tu contraseña haz click en el
                                                                    siguiente botón para resetearla:</span>
                                                            </h1>
                                                            <!--[if mso]></td></tr></table><![endif]-->
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <!--[if mso]><table width="100%"><tr><td><![endif]-->
                                                            <h1 class="v-font-size"
                                                                style="margin: 0px; line-height: 140%; text-align: justify; word-wrap: break-word; font-size: 14px; font-weight: 400;">
                                                                <span>En el caso que no hayas solicitado resetear tu
                                                                    contraseña de Emprendedores |
                                                                    Subsecretaría de Producción, ignora este
                                                                    mail.</span>
                                                            </h1>
                                                            <!--[if mso]></td></tr></table><![endif]-->
