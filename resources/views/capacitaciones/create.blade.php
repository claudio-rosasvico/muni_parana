                        ...
                        <form action="{{ route('capacitacion.store') }} " method="POST">
                            ...
                            <div class="row mt-3">
                                <div class="col">
                                    ...
                                    <x-text-input name="nombre" placeholder="Nombre" id="nombre" class="validacion" required>
                                    </x-text-input>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col col-lg-4">
                                    ...
                                    <x-text-input name="ubicacion" placeholder="Lugar"
                                        id="ubicacion" required></x-text-input>
                                </div>
                                <div class="col col-lg-4">
                                    <x-input-label for="docente">Docente</x-input-label>
                                    <x-text-input name="docente" placeholder="Docente" id="docente" required></x-text-input>
                                </div>
                                <div class="col col-lg-2">
                                    <x-input-label for="fecha">Fecha</x-input-label>
                                    <x-text-input type="date" name="fecha" placeholder="Fecha" id="fecha" required></x-text-input>
                                </div>
                                <div class="col col-lg-2">
                                    <x-input-label for="hora">Hora</x-input-label>
                                    <x-text-input type="time" name="hora" placeholder="Hora" id="hora" required></x-text-input>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col">
                                    <x-input-label for="observaciones">Observaciones</x-input-label>
                                    <x-text-input name="observaciones" placeholder="Observaciones" id="observaciones" class="validacion">
                                    </x-text-input>
                                </div>
                            </div>
                            <div class="row mt-5">
